...
<html>
    ...
    <BODY OnLoad="document.myform.amt.focus();">
            ...
            <table border="1">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><INPUT TYPE=TEXT NAME=bankId value="G2T4" SIZE=10></td>
                    </tr>
                    <tr>
                        <td>Bank Password</td>
                        <td><INPUT TYPE=TEXT NAME=bankPwd value="utilitarianism" SIZE=10></td>
                    </tr>
                    <tr>
                        <td>Your User Id</td>
